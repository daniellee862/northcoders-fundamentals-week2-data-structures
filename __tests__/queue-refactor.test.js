const createQueue = require("../data-structures/queue-refactor");
...
describe("createQueue tests", () => {
  ...
  // test("`reverseEnQueue` method that adds items to the **back** of the queue and top of the object .  Items can only be added if the queue isn't full", () => {
  //   //Arrange
  //   const queueInstance = createQueue();
  //   //ACT
  //   queueInstance.reverseEnQueue("first-item");
  //   queueInstance.reverseEnQueue("second-item");
  //   queueInstance.reverseEnQueue("third-item");
  //   //ASSERT
  //   expect(queueInstance.storage).toEqual({
  //     3: "third-item",
  //     2: "second-item",
